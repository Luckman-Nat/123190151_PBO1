            ...
            switch (pilih) {
                ...
                case 5 -> {
                    ...
                    if(sisi>=1){
                        ...
                        System.out.println("  Keliling Alas Kubus   = " + kubus.KelilingAlas());
                ...
                case 6 -> {
                    ...
                    if(jari>=1) {
                        ...
                        if (tinggi >= 1) {
                            ...
                            System.out.println("  Luas Alas Silinder   = " + silinder.LuasAlas());
                            System.out.println("  Luas Alas Silinder   = " + silinder.KelilingAlas());
                    ...
                    if (panjang >= 1) {
                        ...
                        if (lebar >= 1) {
                            ...
                            if (tinggi >= 1) {
                                ...
                                System.out.println("  Luas Alas Balok   = " + balok.LuasAlas());
                                System.out.println("  Keliling Alas Balok   = " + balok.KelilingAlas());
